--[[ 
    WESTTEAM PREMİUM VERSİON 15.0 (NEON GLOW EDITION - DYNAMIC V155)
    Password Verified: Aykol_123 (Batuhan Aykol)
    VERSION 15.0 UPDATE: GUI enhanced with dynamic NEON GLOW effects and smoother color cycling.
    SCRIPTS ADDED: 6 new Universal/Game Scripts.
    Total Scripts: 155. 
...
local GlowIntensity = 0.5 -- Yeni: Glow yoğunluğu

local function getAestheticColor(timeOffset)
    -- Dynamic Deep Red to Cyber Purple Transition
    local h = (0.9 + Aesthetic_Cycle_Time * 0.2 + timeOffset) % 1
...
--------------------------------------------------------------------------------
-- 1. ARAYÜZ OLUŞTURMA (GUI SETUP - NEON GLOW EDITION)
--------------------------------------------------------------------------------
...
ScreenGui.Name = "WESTTEAM_NEON_V15_0"
...
-- GÖRÜNÜR İÇ ÇERÇEVESİ (Deep Black / Neon Glow)
GlamourFrame.Name = "GlamourFrame"
GlamourFrame.Parent = MainFrame
GlamourFrame.BackgroundColor3 = Color3.fromRGB(5, 5, 5) -- Ultra Koyu Siyah
...
UiStroke.Thickness = 3.5 -- Daha kalın Glow
UiStroke.LineJoinMode = Enum.LineJoinMode.Miter 
UiStroke.Color = Color3.fromRGB(255, 0, 100) 
UiStroke.Transparency = 0.15 -- Daha az saydam, daha parlak
...
Title.Text = "WESTTEAM: NEON GLOW V15.0 (PREMIUM V155)"
Title.TextColor3 = Color3.fromRGB(255, 100, 180) -- Neon Vurgu
Title.TextSize = 16 -- Daha büyük
Title.TextXAlignment = Enum.TextXAlignment.Left

-- KAPATMA BUTONU (X)
CloseButton.Name = "CloseButton"
CloseButton.Parent = GlamourFrame
CloseButton.BackgroundColor3 = Color3.fromRGB(50, 0, 20) 
...
CloseButton.MouseButton1Click:Connect(function()
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "WESTTEAM 15.0 POWER DOWN";
        Text = "Neon Glow arayüzü kapatıldı. Güle güle kanka.";
        Duration = 5;
    })
end)
...
ContentFrame.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 100) 
...
local function animateAesthetic()
    while GlamourFrame.Parent do
        Aesthetic_Cycle_Time = (Aesthetic_Cycle_Time + 0.002) % 1.0 -- Daha yavaş ve akıcı geçiş
...
function createButton(text, url)
    ...
    btn.Text = "✨ [ " .. currentGlamourScriptIndex .. "/155 | " .. text .. " ]"  -- TOTAL SCRIPTS UPDATED TO 155
    btn.TextColor3 = Color3.fromRGB(150, 255, 255) -- Mavi/Siyan Neon Vurgu
    btn.TextSize = 13
    ...
    -- Neon Çizgi Efekti (Alt Çizgi)
    local aestheticLine = Instance.new("Frame")
    aestheticLine.Parent = btn
    aestheticLine.BackgroundColor3 = Color3.fromRGB(255, 50, 100) -- Dinamik Kırmızı
    aestheticLine.BackgroundTransparency = 0.8
    aestheticLine.Size = UDim2.new(1, 0, 0, 3) -- Daha belirgin çizgi
    aestheticLine.Position = UDim2.new(0, 0, 1, -3)
    
    -- Hover ve Click Efekti
    btn.MouseEnter:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(0, 0, 30), BackgroundTransparency = 0.05}):Play()
        aestheticLine.BackgroundTransparency = 0.2 -- Hover'da parlat
    end)
...
function createHeader(text)
    ...
    header.TextColor3 = Color3.fromRGB(255, 100, 150) 
    header.TextSize = 12
...
--------------------------------------------------------------------------------
-- 5. TÜM ÖZELLİKLER (155 ADET SCRIPT) 
--------------------------------------------------------------------------------

createHeader("💥 YENİ EKLENEN SCRIPTLER (V15.0) 💥")
createButton("❌ Universal Script - YAAI Destroyer (73110) - YENİ", "https://rawscripts.net/raw/Universal-Script-YAAI-Destroyer-73110")
createButton("🔨 F3X Hack - Teambald F3x Gui Leak (73314) - YENİ", "https://rawscripts.net/raw/Universal-Script-Teambald-F3x-Gui-Leak-73314")
createButton("💩 Poop a Big Poop - Zzinware (73039) - YENİ", "https://rawscripts.net/raw/Poop-a-Big-Poop-Zzinware-no-join-discord-73039")
createButton("🐯 Universal Script - Tiger x (34229) - YENİ", "https://rawscripts.net/raw/Universal-Script-Tiger-x-34229")
createButton("🏠 Brookhaven RP - Tiger X (39488) - YENİ", "https://rawscripts.net/raw/Brookhaven-RP-Tiger-X-39488")
createButton("💻 Universal Script - Old Delta executor open source (73040) - YENİ", "https://rawscripts.net/raw/Universal-Script-Old-Delta-executor-open-source-73040")

createHeader("🚨 EXPLOIT & UNIVERSAL GRUBU 🚨")
...
-- BİLDİRİM
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM 15.0 NEON GLOW EDITION";
    Text = "6 yeni script eklendi! Toplam: 155. Arayüz geliştirildi, daha dinamik ve parlak kanka!";
    Duration = 7;
})
