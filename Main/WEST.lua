...
local function loadFullModule(Scroll)
    ...
    -- BURAYA YENİ RAW URL YAPILDI: https://pastebin.com/raw/UqqMBLFk
    local moduleUrl = "https://pastebin.com/raw/UqqMBLFk" 
    ...
    if success and type(moduleFunction) == 'function' then
        ...
        warn("Hata: Script Modülü Yüklenemedi. Pastebin linkini (Raw) kontrol edin.")
    end
    return false
end
