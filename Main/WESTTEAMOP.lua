-- İstanbul Beyefendisi'nin Yeni Onayladığı Yedek Plan: WESTTEAM Mini Hub Loader (100 Script Uyumlu)
...
local function loadFullModule(Scroll)
    ...
    local moduleUrl = "https://pastebin.com/raw/VLJwYrgY" 
    ...
    if success and type(moduleFunction) == 'function' then
        ...
        print("Tüm Script Modülü Başarıyla Yüklendi! Artık 100 güncel buton ekranda.")
        if loaderButton then
...
Header.Text = "WESTTEAM OP MENÜ (100 EFSANE SCRİPT!)" 
...
print("WESTTEAM OP MENÜ Başlatıldı. 100 Script'lik tam modülü yüklemek için butona tıklayın.")
