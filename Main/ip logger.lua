...
local scripts = {
	...
	-- NEWEST ADDITION
	{"DEAD-GUN.TXT", "https://raw.githubusercontent.com/mizu-dump/Lua2Loadstring/main/Main/Shackluster2.lua"}
}
...
output.Text = "Project Greenma v4.2.5 | DEAD-GUN + MR-PIXELS + KICK-GUN + SOUL-GUN + BAN-GUN + SCP-096 + Infinite Scroll Ready!"