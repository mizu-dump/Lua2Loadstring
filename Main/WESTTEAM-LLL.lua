--[[ 
    WESTTEAM PREMİUM VERSİON 5.6 (110 SCRIPT - MAX SÜRÜM)
    Password Verified: Aykol_123
    VERSION 5.6 UPDATE: Added 7 new RVVC scripts for various games (TSB, PVB, Forsaken, etc.).
    Total Scripts: 110
...
Title.Text = "WESTTEAM PREMIUM VERSİON 5.6"
...
--------------------------------------------------------------------------------
-- 5. TÜM ÖZELLİKLER (110 ADET SCRIPT) 
--------------------------------------------------------------------------------

-- *** UNIVERSAL / HACK & EXPLOIT ARAÇLARI *** createHeader("UNIVERSAL & HACK ARAÇLARI (110 SCRIPT)")
...
-- *** DİĞER OYUN SCRIPT'LERİ (16 ADET) ***
createHeader("DİĞER OYUN SCRIPT'LERİ (RVVC EKLENDİ)")

createButton("⚔️ TSB GOJO SET (KEY=CRAZY GOJO) - YENİ", function()
...
createButton("‼️İNK GAME SC (KEY=VEX GAME) - YENİ", function()
...
createButton("🌲 99 GECE SC (KEY=REVISION FOREST) - YENİ", function()
...
createButton("✈️ BUİLD A PLANE (KEY=VIVI PLANE) - YENİ", function()
...
createButton("🌱 HOKOLAZA PVB (KEY=CRAZY VS BRAINROT) - YENİ", function()
...
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM PREMIUM";
    Text = "WESTTEAM PREMİUM YÜKLENİYOR...";
    Duration = 7;
})
