...
local function loadFullModule(Scroll)
    ...
    -- BURASI GÜNCELLENDİ: SENİN EN SON 82 SCRİPTİNİN OLDUĞU YENİ RAW URL'Yİ ÇEKİYOR
    local moduleUrl = "https://pastebin.com/raw/TAwNZd9C" 
    ...
    if success and type(moduleFunction) == 'function' then
        ...
        print("Tüm Script Modülü Başarıyla Yüklendi! Artık 82 güncel buton ekranda.")
        if loaderButton then
...
Header.Text = "⭐ WESTTEAM-UNİ (NEON) | 82 Script ⭐" 
...
print("Mini Hub Başlatıldı. 82 Script'lik tam modülü yüklemek için butona tıklayın.")
