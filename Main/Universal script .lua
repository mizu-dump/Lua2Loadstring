...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      ...
      Key = {"121212 hey budak.etek.asih"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
local UniversalTab = Window:CreateTab("Universal scirpt", "globe")
local Section = UniversalTab:CreateSection("•scirpt VIP")
