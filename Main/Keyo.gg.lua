-- 🟣 Keyo GUI Full Script (with function hook + black reopen + working minimize/close)
...
local function runCustomScript()
	...
	-- Example: change walkspeed to 45 (you can replace this)
...
header.TextSize = 16
header.Text = "Administrator: Steam  |    improved by Delta"
...
oooo    oooo                                 
`888   .8P'                                  
 888  d8'     .ooooo.  oooo    ooo  .ooooo.  
 88888[      d88' `88b  `88.  .8'  d88' `88b 
 888`88b.    888ooo888   `88..8'   888   888 
 888  `88b.  888    .o    `888'    888   888 
o888o  o888o `Y8bod8P'     .8'     `Y8bod8P' 
                       .o..P'                
                       `Y8P'                 
]]
ascii.Parent = frame
...
keylbl.TextSize = 14
keylbl.TextColor3 = Color3.fromRGB(150, 90, 255)
keylbl.Text = "[-] Key:"
...
keybox.FocusLost:Connect(function(enterPressed)
	if enterPressed then
		if keybox.Text == VALID_KEY then
			...
			authGui.Size = UDim2.new(0, 250, 0, 35)
			authGui.Position = keylbl.Position
			authGui.BackgroundTransparency = 1
			authGui.Font = Enum.Font.Code
			authGui.TextSize = 16
			authGui.TextColor3 = Color3.fromRGB(100, 255, 140)
			authGui.Text = "[-] Authenticating..."
			authGui.Parent = frame

			task.wait(2)
			authGui.Text = "[-] Hiding console in 5 seconds..."
			task.wait(5)
			
			runCustomScript() -- 🚀 runs your function here
			...
			invalidMsg.TextColor3 = Color3.fromRGB(255, 100, 100)
			invalidMsg.Text = "[-] Invalid Key!"
