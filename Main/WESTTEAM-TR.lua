--[[ 
    WESTTEAM PREMİUM VERSİON 10.0 (QUANTUM HOLO - ANIMATED 3D)
    Password Verified: Aykol_123
    VERSION 10.0 UPDATE: Full 3D Holographic Interface with Light-Saber effects and Matrix theme.
...
ScreenGui.Name = "WestTeamPremiumUI_V10"
...
MainFrame.Size = UDim2.new(0, 600, 0, 440) -- Daha büyük Holo Alanı
...
HoloFrame.BackgroundTransparency = 0.95 -- Neredeyse tamamen şeffaf
...
Title.Text = "WESTTEAM 10.0: QUANTUM HOLO // 122 SCRIPT" -- Başlık Güncellendi
...
TitleGlitch.Text = "WESTTEAM 10.0"
...
CloseButton.MouseButton1Click:Connect(function()
    TweenService:Create(MainFrame, TweenInfo.new(0.3), {Position = UDim2.new(0.5, -300, 1, 0)}):Play() -- Aşağı kayarak kaybolma
    TweenService:Create(HoloFrame, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
    wait(0.3)
    ScreenGui:Destroy() 
    game.StarterGui:SetCore("SendNotification", {
        Title = "WESTTEAM 10.0 POWER DOWN";
...
local function animateHolo()
    while HoloFrame.Parent do
        ...
        -- Kenarlıkların güncellenmesi LightSaber fonksiyonunda zaten yapılıyor
...
--------------------------------------------------------------------------------
local currentHoloScriptIndex = 0
local currentHoloItemCount = 0
local HoloButtonHeight = 38
local HoloHeaderHeight = 25
local HoloPaddingValue = 7

function updateHoloCanvasSize()
    -- Tahmini 122 script + 8 Header = 130 öğe. 
    local totalHeight = currentHoloItemCount * (HoloButtonHeight + HoloPaddingValue) + 100 
    ContentFrame.CanvasSize = UDim2.new(0, 0, 0, totalHeight)
end

function createButton(text, callback)
    currentHoloScriptIndex = currentHoloScriptIndex + 1
    
    local btn = Instance.new("TextButton")
    btn.Parent = ContentFrame
    btn.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    btn.BackgroundTransparency = 0.95 -- Tam şeffaflık
    btn.Size = UDim2.new(1, 0, 0, HoloButtonHeight) -- Daha büyük butonlar
    ...
    spawn(function()
        ...
        while btn.Parent do
            ...
            btn.TextColor3 = rgbColor -- Yazı da hafif renk değiştirsin
    ...
    currentHoloItemCount = currentHoloItemCount + 1
    updateHoloCanvasSize()
    return btn
end
...
function createHeader(text)
    ...
    header.Size = UDim2.new(1, 0, 0, HoloHeaderHeight)
...
--------------------------------------------------------------------------------
-- 5. TÜM ÖZELLİKLER (122 ADET SCRIPT) 
--------------------------------------------------------------------------------
...
createButton("🖼️ un*led Shader menu (73042)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-un*led-Shader-menu-73042"))() end)
...
createButton("⚔️ YARHM (12403)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-YARHM-12403"))() end)
...
createButton("⚔️ UNIVERSAL Dexter Script (Aimbot)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-UNIVERSAL-Dexter-Script-59906"))() end)
...
createButton("☢️ k00pkidd F3X Gui (H@CK Admin)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-k00pkidd-gui-f3x-67601"))() end)
...
createButton("🕊️ Universal Script - Maxus Fly (55159)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Maxus-Fly-55159"))() end)
...
createButton("🛡️ KEYLESS Guest AP/Autoparry (52664)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-KEYLESS-Guest-Definitive-AP-or-Autoparry-AND-MORE-52664"))() end)
createButton("👁️ Spectate (50569)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Spectate-50569"))() end)
...
createButton("🕊️ Invinicible Flight R15 (45414)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Invinicible-Flight-R15-45414"))() end)
...
createButton("☯️ ZENX HUB (66554)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Muscle-Legends-ZENX-HUB-66554"))() end)
...
createButton("🏠 Brookhaven RP - Coquette Hub (41921) - **YENİ**", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Brookhaven-RP-Coquette-Hub-41921"))() end)
createButton("⭐ Brookhaven RP - STELARIUM HUB v2 (67524) - **YENİ**", function() loadstring(game:HttpGet("https://rawscripts.net/raw/Brookhaven-RP-STELARIUM-HUB-v2-ver-op-script-67524"))() end)
...
createButton("☢️ Brookhaven OP Script (FURIA HUB)", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/Dboas123432sx/bsx_hub/refs/heads/main/FURIAHUB-v1"))() end)
...
createHeader("OTHER GAME SCRIPTS (TSB & MORE)")

createButton("⚔️ The Strongest Battlegrounds - Wally West (61724) - **YENİ**", function() loadstring(game:HttpGet("https://rawscripts.net/raw/The-Strongest-Battlegrounds-Wally-West-61724"))() end)
...
createButton("⚔️ TSB GOJO SET (KEY=CRAZY GOJO)", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/hehehe9028/The-strongest-battleground-/refs/heads/main/The%20strongest%20battleground%20RVVC%20SCRIPTS"))() end)
createButton("‼️İNK GAME SC (KEY=VEX GAME)", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/hehehe9028/INK-GAME/refs/heads/main/Ink%20game%20RVVC%20SCRIPTS%20VEX"))() end)
...
createButton("✈️ BUİLD A PLANE (KEY=VIVI PLANE)", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/hehehe9028/RVVC-build-a-plane/refs/heads/main/RVVC%20BUILD%20A%20PLANE%20SCRIPTS"))() end)
...
createButton("⚔️ TSB SUKUNA SET (KEY=RVVC SUKUNA)", function() loadstring(game:HttpGet("https://raw.githubusercontent.com/hehehe9028/RVVC-SUKUNA-SCRIPT/refs/heads/main/Sukuna%20tsb%20RVVC%20SCRIPTS"))() end)
...
createButton("⚔️ The Strongest Battlegrounds Tsb (70997)", function() loadstring(game:HttpGet("https://rawscripts.net/raw/The-Strongest-Battlegrounds-Tsb-script-70997"))() end)
...
-- BİLDİRİM
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM 10.0 [QUANTUM HOLO]";
    Text = "Holografik arayüz başarıyla yüklendi! 122 script ile tam şeffaf 3D deneyimi.";
    Duration = 7;
})
