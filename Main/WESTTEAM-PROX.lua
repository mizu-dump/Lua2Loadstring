--[[ 
    WESTTEAM PREMİUM V40.0 (TOPLAM 149 SCRİPT - MAKSİMUM LİSTE)
    
    YENİLİKLER:
    - ✅ Kullanıcının çalıştırdığı 4 yeni script eklendi.
    - 🌈 RGB Parlaklığı MAKSİMUMA ayarlandı (KÖR OLAK XD).
    - 🔢 Toplam Script Sayacı: 149 olarak güncellendi.
--]]
...
LoadText.Text = "WESTTEAM V40.0 LOADING... (RGB MAX PARLAKLIK) 🌈"
...
TitleBar.Text = "  WESTTEAM V40.0 (FULL SCRIPTS) 🔥"
...
RunService.Heartbeat:Connect(function()
    local cycle = (tick() * 10.0) % 1 -- Hızı biraz artırdım
    local color = Color3.fromHSV(cycle, 1, 1) -- SATURATION ve VALUE (PARLAKLIK) 1'de tutuldu
...
--------------------------------------------------------------------------------
-- 6. SCRİPT EKLEME (149 FULL LİSTE)
--------------------------------------------------------------------------------
...
-- =========== YENİ EKLENEN SCRİPTLER (4 ADET) V40.0 ===========

AddHeader("🌈 YENİ EKLENEN V40.0 SCRIPT'LER (4 ADET) ⚡")
...
-- =========== V39.0'DAN KALAN LİSTE (145 ADET) ===========
...
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM V40.0 YÜKLENDİ - KÖR OLMAYA HAZIR OL! 🌈";
    Text = "Yeni 4 script eklendi. Toplam: " .. currentScriptIndex .. " script listede. RGB MAX!";
    Duration = 7;
})

-- SCRIPT SAYACINI GÜNCELLE
ScriptCountLabel.Text = "Toplam Script Sayısı: " .. currentScriptIndex .. " (149 Script Listede!)"
