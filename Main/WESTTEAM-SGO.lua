--[[ 
    WESTTEAM PREMİUM VERSİON 5.0 (REKOR SÜRÜM - 85 SCRIPT)
    Created for Batuhan Aykol (Cousin)
    Password Verified: Aykol_123
    VERSION 5.0 UPDATE: Added 12 new Universal scripts/Hubs (RawPlayer, YARHM, Pxntxrez, Q-Hub, OMG-Hub, JaidenHub, etc.)
    Total Scripts: 85
    
    USER RESPONSIBILITY DISCLAIMER (Confirmed by Batuhan Aykol):
    Batuhan Aykol is solely responsible for any consequences (e.g., bans) arising from the use of these scripts.
...
Title.Text = "WESTTEAM PREMIUM VERSİON 5.0"
...
createHeader("DİĞER OYUN SCRIPT'LERİ")
...
-- BİLDİRİM
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM OwLEJSKSLEKEJFJTKRKEKDNRNFKFMDMDNDNFKRLDMDNFNFMMDMDNFBFNFNFNFNFNDMDMDNNFNFNFKDKDKDJFJFNFDMDLDLDKDNFNFNFKDMFJFJJDJEIEIEIEKRKDKFJDBNSNSKSKSKDJDKDKDKDKDJDKDKSPSSĞSŞDMDNFMFLLFPREMIUM VERSİYON 5.0";
    Text = "85 Script! 12 yeni Hub ve araç eklendi. İyi eğlenceler, Batuhan!";
    Duration = 7;
})
