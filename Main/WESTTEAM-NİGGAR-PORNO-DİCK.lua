--[[ 
    WESTTEAM PREMİUM VERSİON 14.0 (ADULT GLAMOUR EDITION - DARK NEON V149)
    Password Verified: Aykol_123
    VERSION 14.0 UPDATE: GUI fully redesigned to a "Dark Glamour / Red Neon" theme. (NOTE: Explicit/NSFW content is prohibited and not included.)
    SCRIPTS ADDED: 6 new Exploit/Universal Scripts.
    Total Scripts: 149. 
...
local function getAestheticColor(timeOffset)
    -- Deep Red to Neon Pink Transition
    local h = (0.95 + Aesthetic_Cycle_Time * 0.1) % 1
    return Color3.fromHSV(h, 1, 1) -- Yüksek Doygunluk, Tam Parlaklık
end
...
--------------------------------------------------------------------------------
-- 1. ARAYÜZ OLUŞTURMA (GUI SETUP - ADULT GLAMOUR EDITION)
--------------------------------------------------------------------------------
local ScreenGui = Instance.new("ScreenGui")
local MainFrame = Instance.new("Frame")
local GlamourFrame = Instance.new("Frame") -- İsim SoftFrame'den GlamourFrame'e çevrildi
...
ScreenGui.Name = "WESTTEAM_GLAMOUR_V14_0"
...
-- GÖRÜNÜR İÇ ÇERÇEVESİ (Dark Glamour / Kırmızı Siyah)
GlamourFrame.Name = "GlamourFrame"
GlamourFrame.Parent = MainFrame
GlamourFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- Derin Siyah
GlamourFrame.BackgroundTransparency = 0.05 -- Hafif Saydamlık
...
GlamourCorner.CornerRadius = UDim.new(0, 8) -- Keskin Yuvarlak Köşeler
...
UiStroke.LineJoinMode = Enum.LineJoinMode.Miter -- Keskin Köşeler
UiStroke.Color = Color3.fromRGB(255, 0, 50) -- Parlak Kırmızı
...
Title.Text = "WESTTEAM: ADULT GLAMOUR V14.0 (PREMIUM V149)"
Title.TextColor3 = Color3.fromRGB(255, 50, 80) -- Ateşli Kırmızı
Title.TextSize = 15
...
CloseButton.BackgroundColor3 = Color3.fromRGB(255, 0, 50) -- Parlak Kırmızı
...
CloseCorner.CornerRadius = UDim.new(0, 5) -- Biraz daha keskin
...
CloseButton.MouseButton1Click:Connect(function()
    ...
    game.StarterGui:SetCore("SendNotification", {
        Title = "WESTTEAM 14.0 POWER DOWN";
        Text = "Glamour arayüzü kapatıldı. Görüşürüz kanka.";
        Duration = 5;
    })
end)
...
ContentFrame.BackgroundTransparency = 0.3 -- Koyu Saydam
ContentFrame.BorderSizePixel = 0
ContentFrame.Position = UDim2.new(0, 20, 0, 50) 
ContentFrame.Size = UDim2.new(1, -40, 1, -65)
ContentFrame.ScrollBarThickness = 5 
ContentFrame.ScrollBarImageColor3 = Color3.fromRGB(255, 0, 50) -- Kırmızı Scrollbar
...
--------------------------------------------------------------------------------
-- 4. BUTON EKLEME FONKSİYONLARI (DARK BUTONLAR)
--------------------------------------------------------------------------------
...
function createButton(text, url)
    ...
    btn.BackgroundColor3 = Color3.fromRGB(20, 20, 20) -- Koyu Siyah
    btn.BackgroundTransparency = 0.3 
    btn.Size = UDim2.new(1, 0, 0, 35) 
    btn.Font = Enum.Font.Code
    btn.Text = "🔥 [ " .. currentGlamourScriptIndex .. "/149 | " .. text .. " ]"  -- TOTAL SCRIPTS UPDATED TO 149
    btn.TextColor3 = Color3.fromRGB(255, 50, 100) -- Kırmızı/Pembe Neon
    btn.TextSize = 13
    ...
    btnCorner.CornerRadius = UDim.new(0, 5) -- Biraz daha keskin
    btnCorner.Parent = btn
    
    -- Aesthetic Çizgi Efekti (Alt Çizgi)
    local aestheticLine = Instance.new("Frame")
    aestheticLine.Parent = btn
    aestheticLine.BackgroundColor3 = Color3.fromRGB(255, 0, 50) 
    ...
    btn.MouseEnter:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(40, 0, 10), BackgroundTransparency = 0.1}):Play()
        aestheticLine.BackgroundTransparency = 0.4 
    end)
    btn.MouseLeave:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.1), {BackgroundColor3 = Color3.fromRGB(20, 20, 20), BackgroundTransparency = 0.3}):Play()
        aestheticLine.BackgroundTransparency = 0.8 
    end)
...
function createHeader(text)
    ...
    header.TextColor3 = Color3.fromRGB(255, 100, 150) -- Neon Pembe
    header.TextSize = 11
...
--------------------------------------------------------------------------------
-- 5. TÜM ÖZELLİKLER (149 ADET SCRIPT) 
--------------------------------------------------------------------------------

createHeader("🚨 YENİ EXPLOIT SCRIPT GRUBU 🚨")
...
createHeader("UNIVERSAL & EXPLOIT [GLAMOUR]")
...
createButton("🏠 Brookhaven RP - CARTOLA HUB (69651) - YENİ", "https://rawscripts.net/raw/Brookhaven-RP-cartola-hub-69651") 
...
createButton("🧠 Steal a Brainrot - CARTOLA HUB (54362) - YENİ", "https://rawscripts.net/raw/Steal-a-Brainrot-Cartola-Hub-Steal-A-Brainrot-Desync-OP-54362") 
createButton("🌲 99 Nights - CARTOLA HUB (56729) - YENİ", "https://rawscripts.net/raw/99-Nights-in-the-Forest-Cartola-Hub-56729") 

-- BİLDİRİM
game.StarterGui:SetCore("SendNotification", {
    Title = "WESTTEAM 14.0 GLAMOUR EDITION";
    Text = "6 yeni exploit scripti eklendi! Toplam: 149. Yeni Dark Glamour tema aktif edildi kanka.";
    Duration = 7;
})
