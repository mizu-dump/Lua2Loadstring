...
local neonColors = {
    Color3.fromRGB(0, 255, 255), -- Neon Mavi (Cyan)
    Color3.fromRGB(255, 0, 255), -- Neon Pembe/Mor (Magenta)
    Color3.fromRGB(150, 0, 255)  -- Derin Mor
}
local colorIndex = 1
...
local function loadFullModule(Scroll)
    ...
    -- KULLANICININ YENİ GÜNCEL RAW URL'Sİ BURADA
    local moduleUrl = "https://pastebin.com/raw/FrjYudRg" 
    ...
    if success and type(moduleFunction) == 'function' then
        ...
        print("Tüm Script Modülü Başarıyla Yüklendi! Artık tüm güncel butonlar ekranda.")
    else
...
Header.Text = "⭐ WESTTEAM-UNİ (NEON) ⭐" -- YENİ BAŞLIK
...
-- Animasyonu sürekli çalıştırmak için bir döngü
coroutine.wrap(function()
    while Frame.Parent do
        animateColor()
        wait(1.5) -- Geçiş süresi kadar bekle
    end
end)()
-- RGB ANIMASYON SONU
