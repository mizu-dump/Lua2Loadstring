...
function createButton(text, callback)
    ...
    btn.Size = UDim2.new(1, 0, 0, 38) -- Daha büyük butonlar
...
createButton("🏠 Brookhaven RP - Coquette Hub (41921) - **YENİ**", function()
    loadstring(game:HttpGet("https://rawscripts.net/raw/Brookhaven-RP-Coquette-Hub-41921"))()
end)

createButton("⭐ Brookhaven RP - STELARIUM HUB v2 (67524) - **YENİ**", function()
...
createButton("⚔️ The Strongest Battlegrounds - Wally West (61724) - **YENİ**", function()
