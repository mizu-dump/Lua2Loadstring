-- ===============================================================
-- ♕ WESTTEAM-POWER 6.3.8: NİHAİ SÜRÜM (BLOX FRUIT VE GAG EKLENDİ)
-- Toplam 55 Özellik. Harici scriptler butona tekrar basılarak YENİDEN BAŞLATILABİLİR.
-- Değişiklik: Blox Fruit SC ve Grow A Garden/GAG SC eklendi.
-- ===============================================================
...
-- ===========================================
-- 1. ÖZELLİK DURUMLARI (FLAG'LER) - (TOPLAM 55)
-- ===========================================
...
local isBloxFruitLoaded = false -- 💥 YENİ BLOX FRUIT FLAG
local isGAGLoaded = false -- 💥 YENİ GAG FLAG
...
local SPACER_HEIGHT_LARGE = 300 
local TOTAL_FEATURES_COUNT = 55 -- 💥 SAYI GÜNCELLENDİ
...
local BLOXFRUIT_COLOR = Color3.fromRGB(0, 191, 255) -- 💥 YENİ BLOX FRUIT RENGİ
local GAG_COLOR = Color3.fromRGB(255, 140, 0) -- 💥 YENİ GAG RENGİ
...
Header.Text = "WESTTEAM-POWER ♕ — Unified Admin (V6.3.8)" -- 💥 SÜRÜM GÜNCEL
...
-- ===========================================
-- 3. ÖZELLİK FONKSİYONLARI (Dahili 17)
-- ===========================================
...
local function noClipLoop()
    if not noClipHRP then return end
    ...
    local oldPos = noClipHRP.CFrame.Position
    noClipHRP.CFrame = noClipHRP.CFrame 
    RunService.Stepped:Wait() 
end
local function toggleNoClip(button) 
    isNoClipActive = not isNoClipActive
    local char = LocalPlayer.Character or LocalPlayer.CharacterAdded:Wait()
    noClipHRP = char:WaitForChild("HumanoidRootPart")

    if isNoClipActive then 
        char.Archivable = false 
        noClipHRP.CanCollide = false
        noClipHRP.Massless = true
        noClipLoop = RunService.Heartbeat:Connect(noClipLoop)
        button.Text = "NoClip (Aktif - Gelişmiş V2)"; 
            ...
            if part:IsA("BasePart") and part.CanCollide and part.Transparency < 1 and not part:IsDescendantOf(LocalPlayer.Character) then
                if isXRayActive then
                    ...
                    if originalTransparency[part] ~= nil then
                        ...
                        part.BrickColor = BrickColor.new(part.Name) 
...
-- ===========================================
-- 4. ÖZELLİK FONKSİYONLARI (Harici 38) - YENİDEN BAŞLATMA MANTIĞI
-- ===========================================
...
-- Harici Scriptler Tanımlamaları
...
local toggleBloxFruit = createRerunToggle("isBloxFruitLoaded", "https://raw.githubusercontent.com/AhmadV99/Speed-Hub-X/main/Speed%20Hub%20X.lua", "**Blox Fruit SC 🍍**", BLOXFRUIT_COLOR) -- 💥 YENİ BLOX FRUIT
local toggleGAG = createRerunToggle("isGAGLoaded", "https://raw.githubusercontent.com/Nebula-xyzs/GAG/refs/heads/main/GrowAGardenXE", "**Grow A Garden/GAG SC 🥕**", GAG_COLOR) -- 💥 YENİ GAG
...
-- ===========================================
-- 6. ÖZELLİKLERİ PANELE EKLEME (NİHAİ LİSTE 6.3.8)
-- ===========================================

-- Dahili Özellikler (17 Adet)
createButton("Anti-AFK", toggleAntiAfk)
createButton("NoClip (Gelişmiş V2)", toggleNoClip) 
...
createButton("**Blox Fruit SC 🍍**", toggleBloxFruit) -- 💥 YENİ BLOX FRUIT
createButton("**Grow A Garden/GAG SC 🥕**", toggleGAG) -- 💥 YENİ GAG
...
createSpacer(SPACER_HEIGHT_SMALL) -- 50px
...
-- GÜNCELLENEN VE YENİ EKLENEN SCRİPTLER
...
createSpacer(SPACER_HEIGHT_LARGE) -- 300px BÜYÜK BOŞLUK 

-- Ana Hublar
createButton("WESTTEAM-W (ANA HUB)", toggleWestteamW)
createButton("**WESTTEAM-ADM-PANEL**", toggleAdmPanel)

print("⚔️ WESTTEAM-POWER 6.3.8: BLOX FRUIT VE GAG EKLENDİ. TOPLAM 55 ÖZELLİK.")
