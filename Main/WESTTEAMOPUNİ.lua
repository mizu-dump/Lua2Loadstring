-- İstanbul Beyefendisi'nin Yeni Onayladığı Yedek Plan: WESTTEAM Mini Hub Loader (113 Script Uyumlu)
...
local function loadFullModule(Scroll)
    ...
    local moduleUrl = "https://pastebin.com/raw/QZ1TX2YU" 
    ...
    if loaderButton then
        ...
        loaderButton.Text = "SCRİPTLER GELİYOR REİS..."
    end
    ...
    if success and type(moduleFunction) == 'function' then
        ...
        if loaderButton then
            ...
            loaderButton.Text = "1 KERE DOKUN BURAYA"
        end
    end
    return false
end
...
local function createToggleFeature(name, callback, isToggle)
    ...
    if name == "1 KERE DOKUN BURAYA" then
...
createToggleFeature("1 KERE DOKUN BURAYA", loadFullModule, false)

print("WESTTEAM OP MENÜ Başlatıldı. 113 Script'lik tam modülü yüklemek için butona tıklayın.")
